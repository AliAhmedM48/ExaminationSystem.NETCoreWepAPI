        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Salary = table.Column<decimal>(type: "decimal(16,2)", nullable: true),
                    CreatedBy = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<int>(type: "int", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxTime = table.Column<int>(type: "int", nullable: true),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CourseId = table.Column<int>(type: "int", nullable: true),
                    ExamType = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    Score = table.Column<decimal>(type: "decimal(16,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Score = table.Column<decimal>(type: "decimal(16,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructorCourses_InstructorId_CourseId",
                table: "InstructorCourses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentExamQuestions_ExamId_StudentId",
